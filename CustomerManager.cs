...
class CustomerManager
    {
        ...
        public bool deleteCustomer(int cid)
        {
            int loc = findCustomer(cid);
            if (loc == -1) { return false; }
            if (customerList[loc].getNumBookings() > 0) { return false; }  //  added to avoide deleting the customer with existng bookings
        ...
        public Customer getLastCustomer() { return customerList[numCustomers-1]; }
    }
}
